...
camera_config["transform"] = libcamera.Transform(hflip=1, vflip=0)
...
time.sleep(3)
picam2.capture_file("/home/ENKH/Senior Project/Eagle-Vison2/Tensorflow/workspace/images/collectedimages/thumbsdown/td4.jpg")

#Puts image into variable
image = cv2.imread("/home/ENKH/Senior Project/Eagle-Vison2/Tensorflow/workspace/images/collectedimages/thumbsdown/td4.jpg")
